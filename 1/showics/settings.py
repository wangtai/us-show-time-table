# Django settings for showics project.
...
SECRET_KEY = 'w1w!#x^2=vj9*+!xzfw5e$5t(=uh7a$skm=ql(&@am8g%_hgri'
...
ROOT_URLCONF = 'showics.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'showics.wsgi.application'
